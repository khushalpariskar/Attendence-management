...
Label(root,text='teacher INFORMATION', bg='GREEN',width="300",height="2",font=('calibri',13)).pack()
...
main_frm=Frame(root,bg='green',height=600,width=1050)
...
def updt(a):
    ...
    def name():
        ...
        print('a[]',a[0])
        sql_cmd="select name from teacher where regno='"+str(a[0])+"'"
        ...
        def save(val):
            sql_cmd = "update teacher set name='"+str(val)+"' where regno='"+str(a)+"';"
            mycursor.execute(sql_cmd)
    ...
    def regno():
        ...
        print('a[]',a[0])
        sql_cmd="select regno from teacher where regno='"+str(a[0])+"'"
        mycursor.execute(sql_cmd)
        lbl=mycursor.fetchone()
        old_lbl=Label(frm1,text='OLD DATA:-',height=2,width=50)
        old_lbl.place(x=20,y=20)
        ...
        def save(val):
            sql_cmd = "update teacher set regno='"+str(val)+"' where regno='"+str(a)+"';"
            mycursor.execute(sql_cmd)
            mycursor.execute("commit")
    ...
    def phn():
        ...
        print('a[]',a[0])
        sql_cmd="select contact_number from teacher where regno='"+str(a[0])+"'"
        mycursor.execute(sql_cmd)
        lbl=mycursor.fetchone()
        old_lbl=Label(frm1,text='OLD DATA:-',height=2,width=50)
        old_lbl.place(x=20,y=20)
        ...
        def save(val):
            sql_cmd = "update teacher set contact_number='"+str(val)+"' where regno='"+str(a)+"';"
            mycursor.execute(sql_cmd)
            mycursor.execute("commit")
    ...
    def email():
        ...
        print('a[]',a[0])
        sql_cmd="select email from teacher where regno='"+str(a[0])+"'"
        mycursor.execute(sql_cmd)
        lbl=mycursor.fetchone()
        old_lbl=Label(frm1,text='OLD DATA:-',height=2,width=50)
        old_lbl.place(x=20,y=20)
        ...
        def save(val):
            sql_cmd = "update teacher set email='"+str(val)+"' where regno='"+str(a)+"';"
            mycursor.execute(sql_cmd)
            mycursor.execute("commit")
    ...
    def adr():
        ...
        print('a[]',a[0])
        sql_cmd="select permanent_address from teacher where regno='"+str(a[0])+"'"
        mycursor.execute(sql_cmd)
        lbl=mycursor.fetchone()
        old_lbl=Label(frm1,text='OLD DATA:-',height=2,width=50)
        old_lbl.place(x=20,y=20)
        ...
        def save(val):
            sql_cmd = "update teacher set permanent_address='"+str(val)+"' where regno='"+str(a)+"';"
            mycursor.execute(sql_cmd)
            mycursor.execute("commit")
    ...
    def psd():
        ...
        print('a[]',a[0])
        sql_cmd="select pswd from teacher where regno='"+str(a[0])+"'"
        mycursor.execute(sql_cmd)
        lbl=mycursor.fetchone()
        old_lbl=Label(frm1,text='OLD DATA:-',height=2,width=50)
        old_lbl.place(x=20,y=20)
        ...
        def save(val):
            sql_cmd = "update teacher set pswd='"+str(val)+"' where regno='"+str(a)+"';"
            mycursor.execute(sql_cmd)
            mycursor.execute("commit")
    ...
    Button(mini_frm,text='pswd',height=3,width=20,command=lambda:psd()).pack(side=LEFT)

def dlt(a):
    sql_cmd="delete from  teacher where regno='"+str(a)+"'"
    mycursor.execute(sql_cmd)
    mycursor.execute("commit")
...
def frm(a):
    ...
    lbl.place(x=20,y=10)
    print(a)
    sql_cmd1="select name from teacher where regno='"+str(a[0])+"'"
    mycursor.execute(sql_cmd1)
    n=mycursor.fetchone()
    Label(lb_frm,text=n,height=2,width=40).place(x=300,y=10)
...
sql_cmd="select regno from teacher"
mycursor.execute(sql_cmd)
t=mycursor.fetchall()
