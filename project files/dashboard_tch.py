...
Label(root,text='TEACHER DASHBOARD', bg='GREEN',width="300",height="2",font=('calibri',13)).pack()
...
data=f.read()
sql_name="select name from teacher where regno="+data
mycursor.execute(sql_name)
data1 = mycursor.fetchone()
sql_roll="select regno from teacher where regno="+data
sql_sess="select date_of_birth from teacher where regno="+data
sql_courses="select courses from teacher where regno="+data
