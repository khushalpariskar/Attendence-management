...
Button(center_frame, text="TODAY'S SCHEDULE", bg='sky blue',command=today_class).place(x=130,y=95,width=320,height=45)
Button(center_frame, text="UPDATE CLASSES", bg='sky blue',command=attend_class).place(x=130,y=148,width=320,height=45)
Button(center_frame, text="STUEDNT'S ATTENDENCE", bg='sky blue',command=attendence).place(x=130,y=203,width=320,height=45)
Button(center_frame, text="APPLY FOR LEAVE", bg='sky blue',command=leave).place(x=130,y=258,width=320,height=45)
Button(center_frame, text="LOGOUT", bg='sky blue',command=logout).place(x=130,y=313,width=320,height=45)
#Button(c).place(x=130,y=368,width=320,height=45)
